...
class Renderer {
    public:
        ...
        nanogui::detail::FormWidget<float, std::true_type> *curr_end_pos_x,
            *curr_end_pos_y, *curr_end_pos_z, *x1, *y1, *z1, *x2, *y2, *z2, *x3,
            *y3, *z3;
    ...
    public:
        ...
        void scene_reset();
        void update_gui_values(Bone_Animation *m_bone_animation);
};
